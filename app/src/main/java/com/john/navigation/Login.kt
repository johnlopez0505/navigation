...
import com.john.navigation.fragments.RestaurantFragment
import com.john.navigation.dao.DaoUser
import com.john.navigation.databinding.ActivityLoginBinding
import com.john.navigation.models.Register
...
class Login : AppCompatActivity() {
    ...
    private fun validarCredenciales() {
        ...
        if (usuarioEncontrado != null) {
            ...
            val intenFragment = Intent(this, RestaurantFragment::class.java).apply{
